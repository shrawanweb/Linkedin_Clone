...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    console.log("USER ID OBJECT:", authState.user?.userId);
    console.log("PROFILE PICTURE:", authState.user?.userId?.profilePicture);
  }, [authState.user]);
                      ...
                      return (
                        <div className={styles.singleComment} key={comment._id}>
                          <div className={styles.singleComment_profileContainer}>
                            <img src={`${BASE_URL}/${comment.userId?.name}`} alt="" />
                            <div>
